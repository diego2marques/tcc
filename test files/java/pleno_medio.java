...
public class PlenoMedio {
    ...
    record AuditEntry(int taskId, String action, String at, String detail) {}
    ...
    static class TaskCompletionService {
        private final TaskRepository taskRepository;
        private final AuditGateway auditGateway;
        private final TaskPolicy taskPolicy;
        private final Clock clock;

        TaskCompletionService(TaskRepository taskRepository, AuditGateway auditGateway, TaskPolicy taskPolicy, Clock clock) {
        ...
        TaskCompletionResult execute(int taskId) {
            ...
            auditGateway.publish(new AuditEntry(
                ...
                "Task concluida com validacao de politica e auditoria local"
            ));
